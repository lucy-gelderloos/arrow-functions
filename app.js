...
//    When joe.scope() is invoked, "this" refers to to the "joe schmoe" Student object
// 2. What is "this" when joe.scopeArrow() is invoked?
//    When joe.scopeArrow() is invoked, "this" refers to the global object (in this case, the browser window)
// 3. Explain why "this" is different when an arrow function is used.
//    Arrow functions are globally scoped, so "this" will always refer to the global object
